...
//	}
	...
	public static Student dtoToEntity(StudentDto studentDto) {
		Student student = new Student();
		BeanUtils.copyProperties(studentDto, student);
		if (studentDto.getSchoolYearDto() != null && studentDto.getGradeDto() != null) {
			SchoolYear schoolYear = new SchoolYear();
			BeanUtils.copyProperties(studentDto.getSchoolYearDto(), schoolYear);
			Grade grade = new Grade();
			BeanUtils.copyProperties(studentDto.getGradeDto(), grade);
